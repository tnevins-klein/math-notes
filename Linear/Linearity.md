A function $T : U \to V$ is **linear** if and only if it satifies the following properties, letting $U$ and $V$ be [[Linear/Vector Space|vector spaces]] over some [[Field|field]] $\mathbb{F}$.
